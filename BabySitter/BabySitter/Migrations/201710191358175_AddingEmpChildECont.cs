namespace BabySitter.Migrations
{
    ...
    public partial class AddingEmpChildECont : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        cellNumber = c.Int(nullable: false),
                        name = c.String(),
                        EmergencyContact_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.EmergencyContacts", t => t.EmergencyContact_Id)
                .Index(t => t.EmergencyContact_Id);
